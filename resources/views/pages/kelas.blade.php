...
<div class="col-md-12 col-sm-12 text-right">
	<div class="dropdown">
		<a class="btn btn-info" href="{{url('/kelas/tambah/')}}" role="button">Tambah Data</a>
...
<table class="data-table table stripe hover nowrap">
	<form>
		<thead>
			{{csrf_field()}}
			<tr>
				<th class="table-plus datatable-nosort">No Kelas</th>
				<th>Nama Kelas</th>
		...
		<tbody>
		 ...
		 @foreach ($kelas as $k)
		 <tr>
		 	<td class="table-plus">{{$k->NO_KELAS}}</td>
			<td>{{$k->NAMA_KELAS}}</td>
			<td>
				<!-- <a class="dropdown-item" href="#"><i class="dw dw-edit2"></i> Edit</a>
				<a class="dropdown-item" href="#"><i class="dw dw-delete-3"></i> Delete</a> -->
				<a class="" href="{{url('/kelas/edit/'.$k->NO_KELAS)}}"><i class="dw dw-edit2"></i> Edit | </a>
				<a class="" href="{{url('/kelas/hapus/'.$k->NO_KELAS)}}" onclick="return confirm('apakah anda yakin untuk menghapus?')"><i class="dw dw-delete-3"></i> Delete</a>
			</td>
		</tr>
		@endforeach
	</tbody>
