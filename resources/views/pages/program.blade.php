...
<div class="col-md-12 col-sm-12 text-right">
	<div class="dropdown">
		<a class="btn btn-info" href="{{url('/program/tambah/')}}" role="button">Tambah Data</a>
...
<table class="data-table table stripe hover nowrap">
	<form>
		<thead>
			{{csrf_field()}}
			<tr>
				<th class="table-plus datatable-nosort">No Program</th>
				<th>Nama Program</th>
				<th>Biaya Masuk/Biaya Daftar</th>
				<th>Biaya Bulanan</th>
		...
		<tbody>
		 ...
		 <tr>
		 	<td class="table-plus">{{$p->NO_PROGRAM}}</td>
			<td>{{$p->NAMA_PROGRAM}}</td>
			<td>Rp. {{ number_format($p->BIAYA_MASUK) }}</td>
			<td>Rp. {{ number_format($p->BIAYA_BULANAN) }}</td>
			<td>
				<!-- <a class="dropdown-item" href="#"><i class="dw dw-edit2"></i> Edit</a>
				<a class="dropdown-item" href="#"><i class="dw dw-delete-3"></i> Delete</a> -->
				<a class="" href="{{url('/program/edit/'.$p->NO_PROGRAM)}}"><i class="dw dw-edit2"></i> Edit | </a>
				<a class="" href="{{url('/program/hapus/'.$p->NO_PROGRAM)}}" onclick="return confirm('apakah anda yakin untuk menghapus?')"><i class="dw dw-delete-3"></i> Delete</a>
			</td>
		</tr>
		@endforeach
	</tbody>
